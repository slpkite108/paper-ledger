...
export default function Home() {
  ...
  return <div className="app-shell">
    ...
    <div className="workspace"><aside className="search-panel">
      ...
      <div className="sidebar-note"><Info size={16}/><span>현재 저자 검색원은 OpenAlex입니다. 조회 건수는 이 검색원에 연결된 문헌 수이며 저자의 전체 논문 수를 보장하지 않습니다. ORCID 입력도 OpenAlex 저자 식별에 사용합니다.</span></div>
