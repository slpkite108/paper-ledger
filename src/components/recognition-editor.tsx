...
export function RecognitionEditor({ paper, onChange, onError }: { paper:Paper; onChange:(p:Paper)=>void; onError:(s:string)=>void }) {
  ...
  return <details className="recognition-editor"><summary>SCIE · CS/BK · h5-index 확인과 근거 기록</summary><p>학술지명: <strong>{paper.values.venue||'미확인'}</strong> · ISSN: <strong>{paper.values.issn||'미확인'}</strong></p>
