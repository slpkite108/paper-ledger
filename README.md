...
학술대회는 Crossref 행사·ConferenceInfo의 개최 시작일을 기준으로 표시·정렬합니다. SCIE 내장 범위는 IEEE 167종과 출판사 확인 3종이며, h5는 확인한 기준표를 추가해야 합니다. 자세한 범위는 [사용 안내](documentation/USER_GUIDE.md)에 있습니다.
